...
void RSPBranch_AddRef(uint32_t Target, uint32_t * X86Loc)
{
	...
	uint8_t *KnownCode = (uint8_t*)*(RSPJumpTable + (Target >> 2));
	...
	if (KnownCode == NULL) {
	    ...
	    RSPx86_SetBranch32b((uint32_t *) X86Loc,
				(uint32_t *) KnownCode);
	}
    }
}
...
void RSPx86_SetBranch32b(void *JumpByte, void *Destination)
{
    ...
    //}
    *(uint32_t *) (JumpByte) =
	(uint32_t) ((uint8_t *) Destination -
		    (uint8_t *) ((uint32_t *) JumpByte + 1));
}
...
void RSPCompile_J(void)
{
	...
	RSPJmpLabel32(0);
	RSPBranch_AddRef((RSPOpC.target << 2) & 0xFFC,
			 (uint32_t *) (RSPRecompPos - 4));
...
void RSPCompile_BEQ(void)
{
	...
	uint32_t Target =
	    (RSPCompilePC + ((int16_t) RSPOpC.offset << 2) + 4) & 0xFFC;
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SLTI);
}

void RSPCompile_SLTIU(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SLTIU);
}
...
#ifndef RSPCompile_Immediates
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_ANDI);
    return;
#endif
...
//                      _asm int32_t 3
	...
	if ((Addr & 1) != 0) {
	    ...
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LH);
	    return;
	} else {
...
void RSPCompile_LW(void)
{
...
#ifndef RSPCompile_GPRLoads
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LW);
    return;
#endif
	...
	if ((Addr & 3) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LW);
	    return;
	} else {
...
#ifndef RSPCompile_GPRLoads
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LBU);
    return;
#endif
...
void RSPCompile_LHU(void)
{
...
#ifndef RSPCompile_GPRLoads
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LHU);
    return;
#endif
	...
	if ((Addr & 1) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LHU);
	    return;
	} else {
...
void RSPCompile_SB(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SB);
    return;
#endif
...
void RSPCompile_SH(void)
{
...
#ifndef RSPCompile_GPRStores
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SH);
    return;
#endif
	...
	if ((Offset & 1) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_SH);
	    return;
	} else {
...
void RSPCompile_SW(void)
{
...
#ifndef RSPCompile_GPRStores
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SW);
    return;
#endif
	...
	if ((Addr & 3) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_SW);
	    return;
	} else {
...
void RSPCompile_Special_SLL(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Special_SLL);
    return;
#endif
	...
	RSPShiftLeftSignVariableImmed(&RSP_GPR[RSPOpC.rd].W,
				      (uint8_t) RSPOpC.sa);
    } else {
	RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].W, x86_EAX);
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SRL);
    return;
#endif
    ...
    if (RSPOpC.rd == RSPOpC.rt) {
	RSPShiftRightUnsignVariableImmed(&RSP_GPR[RSPOpC.rd].W,
					 (uint8_t) RSPOpC.sa);
    } else {
	RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].W, x86_EAX);
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SRA);
    return;
#endif
    ...
    if (RSPOpC.rd == RSPOpC.rt) {
	RSPShiftRightSignVariableImmed(&RSP_GPR[RSPOpC.rd].W,
				       (uint8_t) RSPOpC.sa);
    } else {
	RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].W, x86_EAX);
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Special_SLLV);
}

void RSPCompile_Special_SRLV(void)
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SRLV);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Special_SRAV);
}
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Special_BREAK);
    if (RSPNextInstruction != NORMAL) {
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_ADD);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_ADDU);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SUB);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SUBU);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_AND);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_OR);
    return;
#endif
...
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_XOR);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Special_NOR);
}

void RSPCompile_Special_SLT(void)
{
#ifndef RSPCompile_Special
    RSPCheat_r4300iOpcode((void*)RSP_Special_SLT);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Special_SLTU);
}
...
void RSPCompile_Cop0_MF(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Cop0_MF);
    return;
#endif
...
{
#ifndef RSPCompile_Cop0
    RSPCheat_r4300iOpcode((void*)RSP_Cop0_MT);
#else
    CPU_Message(RSPCompilePC, RSPOpcodeName(RSPOpC.Hex, RSPCompilePC));
	...
	RSPPushad();
	RSPCall_Direct((void*)RSP_SP_DMA_READ);
	RSPPopad();
	break;
    case 3:
	RSPMoveVariableToX86reg(&RSP_GPR[RSPOpC.rt].UW, x86_EAX);
	...
	RSPPushad();
	RSPCall_Direct((void*)RSP_SP_DMA_WRITE);
	RSPPopad();
	break;
    case 7:
...
void RSPCompile_Cop2_MF(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Cop2_MF);
    return;
#endif
	...
	RSPMoveVariableToX86regByte(&RSP_Vect[RSPOpC.rd].B[element1],
				    x86_EAX);


	RSPMoveVariableToX86regByte(&RSP_Vect[RSPOpC.rd].B[element2],
				    x86_EBX);
	...
	RSPMoveSxVariableToX86regHalf(&RSP_Vect[RSPOpC.rd].B[element2],
				      x86_EAX);
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Cop2_CF);
}
...
void RSPCompile_Cop2_MT(void)
{
...
#ifndef RSPCompile_Cop2
    RSPCheat_r4300iOpcode((void*)RSP_Cop2_MT);
    return;
#endif
	...
	RSPMoveX86regByteToVariable(x86_EAX,
				    &RSP_Vect[RSPOpC.rd].B[element]);
    } else {

	RSPMoveVariableToX86regHalf(&RSP_GPR[RSPOpC.rt].B[0], x86_EAX);


	RSPMoveX86regHalfToVariable(x86_EAX,
				    &RSP_Vect[RSPOpC.rd].B[element - 1]);
    }
}

void RSPCompile_Cop2_CT(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Cop2_CT);
}
...
void RSP_Element2Mmx(int32_t MmxReg)
{
	...
	if (IsMmx2Enabled == 0) {
	    ...
	    RSPMoveVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].HW[el],
					x86_ECX);
	    ...
	    RSPMmxShuffleMemoryToReg(MmxReg,
				     &RSP_Vect[RSPOpC.rt].DW[Qword],
				     _MMX_SHUFFLE(el, el, el, el));
	}
	break;
    }
}
...
void RSP_MultiElement2Mmx(int32_t MmxReg1, int32_t MmxReg2)
{
	...
	RSPMmxShuffleMemoryToReg(MmxReg1, &RSP_Vect[RSPOpC.rt].DW[0],
				 0xF5);

	RSPMmxShuffleMemoryToReg(MmxReg2, &RSP_Vect[RSPOpC.rt].DW[1],
				 0xF5);
	break;
    case 3:
	/* [1q]    | 1 | 1 | 3 | 3 | 5 | 5 | 7 | 7 | */
...
int32_t RSPCompile_Vector_VMULF_MMX(void)
{
    ...
    if (IsMmxEnabled == 0)
	return 0;
    if ((RSPOpC.rs & 0x0f) >= 2 && (RSPOpC.rs & 0x0f) <= 7
	&& IsMmx2Enabled == 0)
	return 0;
...
void RSPCompile_Vector_VMULF(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMULF);
    return;
#endif
	...
	RSPMoveSxVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].HW[del],
				      x86_EBX);
    }
	...
	RSPMoveSxVariableToX86regHalf(&RSP_Vect[RSPOpC.rd].HW[el],
				      x86_EAX);
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMULU);
}
...
void RSPCompile_Vector_VMUDL(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMUDL);
    return;
#endif
	...
	RSPMoveZxVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].HW[del],
				      x86_EBX);
    }
	...
	RSPMoveZxVariableToX86regHalf(&RSP_Vect[RSPOpC.rd].UHW[el],
				      x86_EAX);
...
void RSPCompile_Vector_VMUDM(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMUDM);
    return;
#endif
    ...
    RSPMoveConstQwordToX86reg((uintptr_t) & RSP_Vect[RSPOpC.rd].HW[0],
			      x86_RBP);

    if (bWriteToDest) {

	RSPMoveConstQwordToX86reg((uintptr_t) & RSP_Vect[RSPOpC.sa].HW[0],
				  x86_RCX);
    } else if (!bOptimize) {

	RSPMoveConstQwordToX86reg((uintptr_t) & RSP_Vect[RSPOpC.rt].HW[0],
				  x86_RCX);
    }
	...
	if (bOptimize == 0) {
		...
		RSPMoveZxX86RegPtrDispToX86RegHalf(x86_RCX, del * 2,
						   x86_EBX);
	    }
	}
	...
	if (bWriteToAccum == 0 && bWriteToDest == 1) {
		...
		RSPMoveX86regHalfToX86regPointerDisp(x86_EDX, x86_ECX,
						     el * 2);
	    }
	}
    }
...
void RSPCompile_Vector_VMUDN(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMUDN);
    return;
#endif
...
//      RSPBreakPoint();
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMUDH);
    return;
#endif
	...
	RSPMoveConstQwordToX86reg((uintptr_t) & RSP_ACCUM[0].W[0],
				  x86_RBP);
...
void RSPCompile_Vector_VMACF(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMACF);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMACU);
}

void RSPCompile_Vector_VMACQ(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMACQ);
}
...
void RSPCompile_Vector_VMADL(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMADL);
    return;
#endif
	...
	RSPMoveZxVariableToX86regHalf(&RSP_Vect[RSPOpC.rd].HW[el],
				      x86_EAX);
	...
	if (bWriteToDest != 0) {
	    ...
	    RSPMoveX86regHalfToVariable(x86_ECX,
					&RSP_Vect[RSPOpC.sa].HW[el]);
	}
    }
...
void RSPCompile_Vector_VMADM(void)
{
	...
	if (bOptimize == 0) {
		...
		RSPMoveZxX86RegPtrDispToX86RegHalf(x86_ECX, del * 2,
						   x86_EBX);
	    }
	}
...
void RSPCompile_Vector_VMADN(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMADN);
    return;
#endif
...
void RSPCompile_Vector_VMADH(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMADH);
    return;
#endif
	...
	if (bWriteToDest) {
	    ...
	    RSPMoveConstQwordToX86reg((uintptr_t) & RSP_Vect[RSPOpC.sa].
				      HW[0], x86_RCX);
	} else if (!bOptimize) {

	    RSPMoveConstQwordToX86reg((uintptr_t) & RSP_Vect[RSPOpC.rt].
				      HW[0], x86_RCX);
	}
	...
	for (count = 0; count < 8; count++) {
		...
		if (bWriteToDest == 1) {
		    ...
		    RSPMoveSxVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].
						  HW[del], x86_EBX);
		} else {
		    RSPMoveSxX86RegPtrDispToX86RegHalf(x86_RCX, del * 2,
						       x86_EBX);
		}
	    }
		...
		/*
		   RSPMoveX86regHalfToVariable(x86_EAX, &RSP_Vect[RSPOpC.sa].HW[el]); */
		RSPMoveX86regHalfToX86regPointerDisp(x86_EAX, x86_ECX,
						     el * 2);
	    }
	}
	RSPPop(x86_RBP);
...
void RSPCompile_Vector_VADD(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VADD);
    return;
#endif
...
void RSPCompile_Vector_VSUB(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VSUB);
    return;
#endif
...
void RSPCompile_Vector_VABS(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VABS);
    return;
#endif
	...
	if (RSPOpC.rd == RSPOpC.rt && (RSPOpC.rs & 0xF) < 2) {
		...
		RSPMoveX86regHalfToVariable(x86_EDI,
					    &RSP_Vect[RSPOpC.sa].HW[el]);
	    }
	    if (bWriteToAccum == 1) {
...
void RSPCompile_Vector_VSUBC(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VSUBC);
    return;
#endif
...
void RSPCompile_Vector_VSAW(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VSAW);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VLT);
}

void RSPCompile_Vector_VEQ(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VEQ);
}

void RSPCompile_Vector_VNE(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VNE);
}
...
int32_t RSPCompile_Vector_VGE_MMX(void)
{
    ...
    if ((RSPOpC.rs & 0xF) >= 2 && (RSPOpC.rs & 0xF) <= 7
	&& IsMmx2Enabled == 0)
	return 0;
    ...
    RSPMmxCompareGreaterWordRegToReg(x86_MM3,
				     ((RSPOpC.rs & 0x0f) >=
				      8) ? x86_MM4 : x86_MM5);
    ...
    RSPMmxPandnRegToReg(x86_MM3,
			((RSPOpC.rs & 0x0f) >= 8) ? x86_MM4 : x86_MM5);
...
/*	#if defined (DLIST)
	...
	#endif
*/
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VGE);
}

void RSPCompile_Vector_VCL(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VCL);
}

void RSPCompile_Vector_VCH(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VCH);
}

void RSPCompile_Vector_VCR(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VCR);
}
...
void RSPCompile_Vector_VMRG(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMRG);
    return;
#endif
...
void RSPCompile_Vector_VAND(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VAND);
    return;
#endif
	...
	if (bElement == 0) {
	    ...
	    RSPAndVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].HW[del],
				       x86_EAX);
	} else {
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VNAND);
}
...
void RSPCompile_Vector_VOR(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VOR);
    return;
#endif
	...
	if (bElement == 0) {
	    ...
	    RSPOrVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].HW[del],
				      x86_EAX);
	} else {
	    RSPOrX86RegToX86Reg(x86_EAX, x86_EBX);
	}
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VNOR);
}
...
int32_t RSPCompile_Vector_VXOR_MMX(void)
{
	...
	RSPMmxMoveQwordRegToVariable(VXOR_DynaRegCount + 1,
				     &RSP_Vect[RSPOpC.sa].UHW[0]);

	RSPMmxMoveQwordRegToVariable(VXOR_DynaRegCount + 1,
				     &RSP_Vect[RSPOpC.sa].UHW[4]);
	...
	if ((RSPOpC.rs & 0xF) >= 8) {
	    ...
	    RSPMmxMoveQwordVariableToReg(x86_MM2,
					 &RSP_Vect[RSPOpC.rt].HW[0]);

	    RSPMmxMoveQwordVariableToReg(x86_MM3,
					 &RSP_Vect[RSPOpC.rt].HW[4]);
...
void RSPCompile_Vector_VXOR(void)
{
    ...
    if (!bWriteToAccum
	|| ((RSPOpC.rs & 0xF) < 2 && RSPOpC.rd == RSPOpC.rt)) {
    ...
    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Vector_VXOR);
}

void RSPCompile_Vector_VNXOR(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VNXOR);
}

void RSPCompile_Vector_VRCP(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VRCP);
}

void RSPCompile_Vector_VRCPL(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VRCPL);
}
...
void RSPCompile_Vector_VRCPH(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VRCPH);
    return;
#endif
	...
	if (el != last) {
	    ...
	    RSPMoveVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].UHW[el],
					x86_EAX);
	    last = el;
	}
...
void RSPCompile_Vector_VMOV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VMOV);
    return;
#endif
...
{
    CPU_Message(RSPCompilePC, RSPOpcodeName(RSPOpC.Hex, RSPCompilePC));
    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Vector_VRSQ);
}

void RSPCompile_Vector_VRSQL(void)
{
    CPU_Message(RSPCompilePC, RSPOpcodeName(RSPOpC.Hex, RSPCompilePC));
    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Vector_VRSQL);
}
...
void RSPCompile_Vector_VRSQH(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Vector_VRSQH);
    return;
#endif
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LBV);
}
...
void RSPCompile_Opcode_LSV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LSV);
    return;
#endif
	...
	if ((Addr & 1) != 0) {
	    ...
	    RSPMoveX86regByteToVariable(x86_ECX,
					&RSP_Vect[RSPOpC.rt].B[15 -
							       (RSPOpC.
								del + 0)]);

	    RSPMoveX86regByteToVariable(x86_EDX,
					&RSP_Vect[RSPOpC.rt].B[15 -
							       (RSPOpC.
								del + 1)]);
	} else {
	    ...
	    RSPMoveX86regHalfToVariable(x86_EDX,
					&RSP_Vect[RSPOpC.rt].B[15 -
							       (RSPOpC.
								del + 1)]);
	}
...
void RSPCompile_Opcode_LLV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LLV);
    return;
#endif
	...
	if ((Addr & 3) != 0) {
	    ...
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LLV);
	    return;
	}
	...
	RSPMoveX86regToVariable(x86_EAX,
				&RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del -
						       4]);
	return;
    }
    ...
    *((uint32_t *) (Jump[0])) = (uint32_t) (RSPRecompPos - Jump[0] - 4);
    ...
    RSPMoveX86regToVariable(x86_EAX,
			    &RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del - 4]);
...
void RSPCompile_Opcode_LDV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LDV);
    return;
#endif
	...
	if ((Addr & 3) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LDV);
	    return;
	}
	...
	RSPMoveX86regToVariable(x86_ECX,
				&RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del -
						       8]);
	return;
    }
...
/*    mov eax, ebx
    ...
    RSPMoveX86regToVariable(x86_ECX,
			    &RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del - 8]);
...
void RSPCompile_Opcode_LQV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LQV);
    return;
#endif
	...
	if (Addr & 15) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LQV);
	    return;
	}
	...
	if (IsSseEnabled == 0) {
	    ...
	    RSPSseMoveAlignedRegToVariable(x86_XMM0,
					   &RSP_Vect[RSPOpC.rt].B[0]);
	}
	return;
    }
...
void RSPCompile_Opcode_LRV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LRV);
    return;
#endif
	...
	RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_LRV);
	RSPJmpLabel32(0);
	Jump[1] = RSPRecompPos - 4;
...
//      RSPBreakPoint();
//Int3();
    RSPAddQwordToX86Reg(x86_RAX,
			((uintptr_t) & RSP_Vect[RSPOpC.rt].UB[0]) - 2);
    ...
    if (Compiler.bAlignVector == 0) {
	CPU_Message("   Done:");
	RSPx86_SetBranch32b((uint32_t *) Jump[1],
			    (uint32_t *) RSPRecompPos);
    }
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LPV);
}

void RSPCompile_Opcode_LUV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LUV);
}


void RSPCompile_Opcode_LHV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LHV);
}


void RSPCompile_Opcode_LFV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LFV);
}

void RSPCompile_Opcode_LTV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_LTV);
}
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SBV);
}
...
void RSPCompile_Opcode_SSV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SSV);
    return;
#endif
	...
	if ((Addr & 1) != 0) {
	    ...
	    RSPMoveVariableToX86regByte(&RSP_Vect[RSPOpC.rt].
					B[15 - (RSPOpC.del + 0)], x86_ECX);

	    RSPMoveVariableToX86regByte(&RSP_Vect[RSPOpC.rt].
					B[15 - (RSPOpC.del + 1)], x86_EDX);
	    ...
	    RSPMoveVariableToX86regHalf(&RSP_Vect[RSPOpC.rt].
					B[15 - (RSPOpC.del + 1)], x86_ECX);
...
void RSPCompile_Opcode_SLV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SLV);
    return;
#endif
...
//      }
	...
	if ((Addr & 3) != 0) {
	    ...
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_SLV);
	    return;
	}


	RSPMoveVariableToX86reg(&RSP_Vect[RSPOpC.rt].
				B[16 - RSPOpC.del - 4], x86_EAX);
    ...
    *((uint32_t *) (Jump[0])) = (uint32_t) (RSPRecompPos - Jump[0] - 4);
    ...
    RSPMoveVariableToX86reg(&RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del - 4],
			    x86_EAX);
...
void RSPCompile_Opcode_SDV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SDV);
    return;
#endif
	...
	if ((Addr & 3) != 0) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_SDV);
	    return;
	}
    ...
    RSPMoveVariableToX86reg(&RSP_Vect[RSPOpC.rt].B[16 - RSPOpC.del - 8],
			    x86_ECX);
    RSPMoveX86regToN64Mem(x86_EAX, x86_EBX);
...
void RSPCompile_Opcode_SQV(void)
{
    ...
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SQV);
    return;
#endif
	...
	if (Addr & 15) {
	    CompilerWarning(RSPCompilePC);
	    RSPCheat_r4300iOpcodeNoMessage((void*)RSP_Opcode_SQV);
	    return;
	}
	...
	if (IsSseEnabled == 0) {
	    ...
	    RSPSseMoveAlignedVariableToReg(&RSP_Vect[RSPOpC.rt].B[0],
					   x86_XMM0);
	    RSPSseShuffleReg(x86_XMM0, x86_MM0, 0x1b);
...
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SRV);
}

void RSPCompile_Opcode_SPV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SPV);
}

void RSPCompile_Opcode_SUV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SUV);
}

void RSPCompile_Opcode_SHV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SHV);
}

void RSPCompile_Opcode_SFV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SFV);
}

void RSPCompile_Opcode_STV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_STV);
}

void RSPCompile_Opcode_SWV(void)
{
    RSPCheat_r4300iOpcode((void*)RSP_Opcode_SWV);
}
