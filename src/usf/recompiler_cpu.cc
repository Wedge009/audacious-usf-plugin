...
TARGET_INFO *TargetInfo=0;
int16_t FPU_RoundingMode = 0x0000;	//_RC_NEAR

void CreateSectionLinkage(BLOCK_SECTION * Section);
void DetermineLoop(BLOCK_SECTION * Section, uint32_t Test, uint32_t Test2,
		   uint32_t TestID);
uint32_t DisplaySectionInformation(BLOCK_SECTION * Section, uint32_t ID,
				   uint32_t Test);
BLOCK_SECTION *ExistingSection(BLOCK_SECTION * StartSection, uint32_t Addr,
			       uint32_t Test);
...
void InitilzeSection(BLOCK_SECTION * Section, BLOCK_SECTION * Parent,
		     uint32_t StartAddr, uint32_t ID);
void InitilizeRegSet(REG_INFO * RegSet);
uint32_t IsAllParentLoops(BLOCK_SECTION * Section, BLOCK_SECTION * Parent,
			  uint32_t IgnoreIfCompiled, uint32_t Test);
...
void AddParent(BLOCK_SECTION * Section, BLOCK_SECTION * Parent)
{
	...
	for (NoOfParents = 0; Section->ParentSection[NoOfParents] != NULL;
	     NoOfParents++) {
	...
	Section->ParentSection =
	    (void**)malloc((NoOfParents + 1) * sizeof(void *));
    } else {
	Section->ParentSection = (void**)
	    realloc(Section->ParentSection,
		    (NoOfParents + 1) * sizeof(void *));
    }
	...
	if (Parent->ContinueSection == Section) {
	    memcpy(&Section->RegStart, &Parent->Cont.RegSet,
		   sizeof(REG_INFO));
	} else if (Parent->JumpSection == Section) {
	    memcpy(&Section->RegStart, &Parent->Jump.RegSet,
		   sizeof(REG_INFO));
	} else {
	}
	memcpy(&Section->RegWorking, &Section->RegStart, sizeof(REG_INFO));
	...
	if (Parent->ContinueSection == Section) {
		...
		if (Section->RegStart.MIPS_RegState[count] !=
		    Parent->Cont.RegSet.MIPS_RegState[count]) {
	...
	if (Parent->JumpSection == Section) {
	    for (count = 0; count < 32; count++) {
		if (Section->RegStart.MIPS_RegState[count] !=
		    Parent->Jump.RegSet.MIPS_RegState[count]) {
		    Section->RegStart.MIPS_RegState[count] = STATE_UNKNOWN;
		}
	    }
	}
...
void AnalyseBlock(void)
{
    ...
    InitilzeSection(Section, NULL, BlockInfo.StartVAddr,
		    BlockInfo.NoOfSections);
    CreateSectionLinkage(Section);
    DetermineLoop(Section, GetNewTestValue(), GetNewTestValue(),
		  Section->SectionID);
    do {
	Changed = 0;
...
uint8_t *Compiler4300iBlock(void)
{
	...
	CompileExit(BlockInfo.ExitInfo[count]->TargetPC,
		    &BlockInfo.ExitInfo[count]->ExitRegSet,
...
uint8_t *CompileDelaySlot(void)
{
	...
	case R4300i_SPECIAL_BREAK:
	    Compile_R4300i_SPECIAL_BREAK(Section);
	    break;
	case R4300i_SPECIAL_SLL:
	    Compile_R4300i_SPECIAL_SLL(Section);
	    break;
	case R4300i_SPECIAL_SRL:
	    Compile_R4300i_SPECIAL_SRL(Section);
	    break;
	case R4300i_SPECIAL_SRA:
	    Compile_R4300i_SPECIAL_SRA(Section);
	    break;
	case R4300i_SPECIAL_SLLV:
	    Compile_R4300i_SPECIAL_SLLV(Section);
	    break;
	case R4300i_SPECIAL_SRLV:
	    Compile_R4300i_SPECIAL_SRLV(Section);
	    break;
	case R4300i_SPECIAL_SRAV:
	    Compile_R4300i_SPECIAL_SRAV(Section);
	    break;
	case R4300i_SPECIAL_MFLO:
	    Compile_R4300i_SPECIAL_MFLO(Section);
	    break;
	case R4300i_SPECIAL_MTLO:
	    Compile_R4300i_SPECIAL_MTLO(Section);
	    break;
	case R4300i_SPECIAL_MFHI:
	    Compile_R4300i_SPECIAL_MFHI(Section);
	    break;
	case R4300i_SPECIAL_MTHI:
	    Compile_R4300i_SPECIAL_MTHI(Section);
	    break;
	case R4300i_SPECIAL_MULT:
	    Compile_R4300i_SPECIAL_MULT(Section);
	    break;
	case R4300i_SPECIAL_DIV:
	    Compile_R4300i_SPECIAL_DIV(Section);
	    break;
	case R4300i_SPECIAL_DIVU:
	    Compile_R4300i_SPECIAL_DIVU(Section);
	    break;
	case R4300i_SPECIAL_MULTU:
	    Compile_R4300i_SPECIAL_MULTU(Section);
	    break;
	case R4300i_SPECIAL_DMULTU:
	    Compile_R4300i_SPECIAL_DMULTU(Section);
	    break;
	case R4300i_SPECIAL_DDIVU:
	    Compile_R4300i_SPECIAL_DDIVU(Section);
	    break;
	case R4300i_SPECIAL_ADD:
	    Compile_R4300i_SPECIAL_ADD(Section);
	    break;
	case R4300i_SPECIAL_ADDU:
	    Compile_R4300i_SPECIAL_ADDU(Section);
	    break;
	case R4300i_SPECIAL_SUB:
	    Compile_R4300i_SPECIAL_SUB(Section);
	    break;
	case R4300i_SPECIAL_SUBU:
	    Compile_R4300i_SPECIAL_SUBU(Section);
	    break;
	case R4300i_SPECIAL_AND:
	    Compile_R4300i_SPECIAL_AND(Section);
	    break;
	case R4300i_SPECIAL_OR:
	    Compile_R4300i_SPECIAL_OR(Section);
	    break;
	case R4300i_SPECIAL_XOR:
	    Compile_R4300i_SPECIAL_XOR(Section);
	    break;
	case R4300i_SPECIAL_SLT:
	    Compile_R4300i_SPECIAL_SLT(Section);
	    break;
	case R4300i_SPECIAL_SLTU:
	    Compile_R4300i_SPECIAL_SLTU(Section);
	    break;
	case R4300i_SPECIAL_DADD:
	    Compile_R4300i_SPECIAL_DADD(Section);
	    break;
	case R4300i_SPECIAL_DADDU:
	    Compile_R4300i_SPECIAL_DADDU(Section);
	    break;
	case R4300i_SPECIAL_DSLL32:
	    Compile_R4300i_SPECIAL_DSLL32(Section);
	    break;
	case R4300i_SPECIAL_DSRA32:
	    Compile_R4300i_SPECIAL_DSRA32(Section);
	    break;
	default:
	...
	break;
    case R4300i_ADDI:
	Compile_R4300i_ADDI(Section);
	break;
    case R4300i_ADDIU:
	Compile_R4300i_ADDIU(Section);
	break;
    case R4300i_SLTI:
	Compile_R4300i_SLTI(Section);
	break;
    case R4300i_SLTIU:
	Compile_R4300i_SLTIU(Section);
	break;
    case R4300i_ANDI:
	Compile_R4300i_ANDI(Section);
	break;
    case R4300i_ORI:
	Compile_R4300i_ORI(Section);
	break;
    case R4300i_XORI:
	Compile_R4300i_XORI(Section);
	break;
    case R4300i_LUI:
	Compile_R4300i_LUI(Section);
	break;
    case R4300i_CP1:
	switch (Opcode.rs) {
	case R4300i_COP1_CF:
	    Compile_R4300i_COP1_CF(Section);
	    break;
	case R4300i_COP1_MT:
	    Compile_R4300i_COP1_MT(Section);
	    break;
	case R4300i_COP1_CT:
	    Compile_R4300i_COP1_CT(Section);
	    break;
	case R4300i_COP1_MF:
	    Compile_R4300i_COP1_MF(Section);
	    break;
	case R4300i_COP1_S:
	    switch (Opcode.funct) {
	    case R4300i_COP1_FUNCT_ADD:
		Compile_R4300i_COP1_S_ADD(Section);
		break;
	    case R4300i_COP1_FUNCT_SUB:
		Compile_R4300i_COP1_S_SUB(Section);
		break;
	    case R4300i_COP1_FUNCT_MUL:
		Compile_R4300i_COP1_S_MUL(Section);
		break;
	    case R4300i_COP1_FUNCT_DIV:
		Compile_R4300i_COP1_S_DIV(Section);
		break;
	    case R4300i_COP1_FUNCT_ABS:
		Compile_R4300i_COP1_S_ABS(Section);
		break;
	    case R4300i_COP1_FUNCT_NEG:
		Compile_R4300i_COP1_S_NEG(Section);
		break;
	    case R4300i_COP1_FUNCT_SQRT:
		Compile_R4300i_COP1_S_SQRT(Section);
		break;
	    case R4300i_COP1_FUNCT_MOV:
		Compile_R4300i_COP1_S_MOV(Section);
		break;
	    case R4300i_COP1_FUNCT_CVT_D:
		Compile_R4300i_COP1_S_CVT_D(Section);
		break;
	    case R4300i_COP1_FUNCT_ROUND_W:
		Compile_R4300i_COP1_S_ROUND_W(Section);
		break;
	    case R4300i_COP1_FUNCT_TRUNC_W:
		Compile_R4300i_COP1_S_TRUNC_W(Section);
		break;
	    case R4300i_COP1_FUNCT_FLOOR_W:
		Compile_R4300i_COP1_S_FLOOR_W(Section);
		break;
	...
	case R4300i_COP1_D:
	    switch (Opcode.funct) {
	    case R4300i_COP1_FUNCT_ADD:
		Compile_R4300i_COP1_D_ADD(Section);
		break;
	    case R4300i_COP1_FUNCT_SUB:
		Compile_R4300i_COP1_D_SUB(Section);
		break;
	    case R4300i_COP1_FUNCT_MUL:
		Compile_R4300i_COP1_D_MUL(Section);
		break;
	    case R4300i_COP1_FUNCT_DIV:
		Compile_R4300i_COP1_D_DIV(Section);
		break;
	    case R4300i_COP1_FUNCT_ABS:
		Compile_R4300i_COP1_D_ABS(Section);
		break;
	    case R4300i_COP1_FUNCT_NEG:
		Compile_R4300i_COP1_D_NEG(Section);
		break;
	    case R4300i_COP1_FUNCT_SQRT:
		Compile_R4300i_COP1_D_SQRT(Section);
		break;
	    case R4300i_COP1_FUNCT_MOV:
		Compile_R4300i_COP1_D_MOV(Section);
		break;
	    case R4300i_COP1_FUNCT_TRUNC_W:
		Compile_R4300i_COP1_D_TRUNC_W(Section);
		break;
	    case R4300i_COP1_FUNCT_CVT_S:
		Compile_R4300i_COP1_D_CVT_S(Section);
		break;
	    case R4300i_COP1_FUNCT_CVT_W:
		Compile_R4300i_COP1_D_CVT_W(Section);
		break;
	    case R4300i_COP1_FUNCT_C_F:
	    case R4300i_COP1_FUNCT_C_UN:
	    case R4300i_COP1_FUNCT_C_EQ:
	...
	case R4300i_COP1_W:
	    switch (Opcode.funct) {
	    case R4300i_COP1_FUNCT_CVT_S:
		Compile_R4300i_COP1_W_CVT_S(Section);
		break;
	    case R4300i_COP1_FUNCT_CVT_D:
		Compile_R4300i_COP1_W_CVT_D(Section);
		break;
	    default:
		Compile_R4300i_UnknownOpcode(Section);
		break;
	...
	break;
    case R4300i_LB:
	Compile_R4300i_LB(Section);
	break;
    case R4300i_LH:
	Compile_R4300i_LH(Section);
	break;
    case R4300i_LW:
	Compile_R4300i_LW(Section);
	break;
    case R4300i_LBU:
	Compile_R4300i_LBU(Section);
	break;
    case R4300i_LHU:
	Compile_R4300i_LHU(Section);
	break;
    case R4300i_SB:
	Compile_R4300i_SB(Section);
	break;
    case R4300i_SH:
	Compile_R4300i_SH(Section);
	break;
    case R4300i_SW:
	Compile_R4300i_SW(Section);
	break;
    case R4300i_SWR:
	Compile_R4300i_SWR(Section);
	break;
    case R4300i_CACHE:
	Compile_R4300i_CACHE(Section);
	break;
    case R4300i_LWC1:
	Compile_R4300i_LWC1(Section);
	break;
    case R4300i_LDC1:
	Compile_R4300i_LDC1(Section);
	break;
    case R4300i_LD:
	Compile_R4300i_LD(Section);
	break;
    case R4300i_SWC1:
	Compile_R4300i_SWC1(Section);
	break;
    case R4300i_SDC1:
	Compile_R4300i_SDC1(Section);
	break;
    case R4300i_SD:
	Compile_R4300i_SD(Section);
	break;
    default:
	Compile_R4300i_UnknownOpcode(Section);
	break;
...
void CompileExit(uint32_t TargetPC, REG_INFO * ExitRegSet, int reason,
		 int CompileNow, void (*x86Jmp) (uintptr_t Value))
{
	...
	if (BlockInfo.ExitCount == 0) {
	    ...
	    BlockInfo.ExitInfo = (EXIT_INFO**)
		realloc(BlockInfo.ExitInfo,
			(BlockInfo.ExitCount + 1) * sizeof(void *));
	}
	if (x86Jmp == NULL) {
	    StopEmulation();
	}
	x86Jmp(0);
	BlockInfo.ExitInfo[BlockInfo.ExitCount] =
	    (EXIT_INFO*) malloc(sizeof(EXIT_INFO));
	...
	BlockInfo.ExitInfo[BlockInfo.ExitCount]->NextInstruction =
	    NextInstruction;
	...
	MoveConstToVariable(TargetPC, &PROGRAM_COUNTER);
    }
    ...
    if (ExitRegSet->RandomModifier != 0) {
	SubConstFromVariable(ExitRegSet->RandomModifier, &CP0[1]);
    }
    WriteBackRegisters(&Section);

    switch (reason) {
    case Normal:
    case Normal_NoSysCheck:
	Section.RegWorking.RandomModifier = 0;
	Section.RegWorking.CycleCount = 0;
	if (reason == Normal) {
	    CompileSystemCheck(0, (uint32_t) - 1, Section.RegWorking);
	}
	...
	if (TargetPC >= 0x80000000 && TargetPC < 0x90000000) {
	    ...
	    JeLabel8(0);
	    Jump2 = RecompPos - 1;
	    AddConstToX86Reg(x86_ECX,
			     (int32_t) JumpTable - (int32_t) N64MEM);
	...
	break;
    case DoSysCall:
	MoveConstToX86reg(NextInstruction == JUMP
			  || NextInstruction == DELAY_SLOT, x86_EDI);
	printf("extinjg 1\n");
	exit(0);
	Pushad();
	Call_Direct((void (*)())DoSysCallException);
	Popad();
	Ret();
	break;
    case COP1_Unuseable:
	...
	Call_Direct((void (*)())DoCopUnusableException);
	Popad();
	Ret();
	break;
...
/*	} __except( r4300i_CPU_MemoryFilter( GetExceptionCode(), GetExceptionInformation()) ) {
	...
	if (*TargetPC[count] != (uint32_t) - 1
	    && *TargetSection[count] == NULL) {
	    *TargetSection[count] =
		ExistingSection((BLOCK_SECTION*)BlockInfo.BlockInfo.ContinueSection,
				*TargetPC[count], GetNewTestValue());
	    if (*TargetSection[count] == NULL) {
		*TargetSection[count] =
		    ExistingSection((BLOCK_SECTION*)BlockInfo.BlockInfo.JumpSection,
				    *TargetPC[count], GetNewTestValue());
	    }
	    if (*TargetSection[count] == NULL) {
		BlockInfo.NoOfSections += 1;
		*TargetSection[count] = (BLOCK_SECTION*)malloc(sizeof(BLOCK_SECTION));
		InitilzeSection(*TargetSection[count], Section,
				*TargetPC[count], BlockInfo.NoOfSections);
		   ...
		   uint32_t TestID)
{
	...
	DetermineLoop((BLOCK_SECTION*)Section->ContinueSection, Test, GetNewTestValue(),
		      ((BLOCK_SECTION *) Section->ContinueSection)->
		      SectionID);
    }
    if (Section->JumpSection != NULL) {
	DetermineLoop((BLOCK_SECTION*) Section->JumpSection, Test, GetNewTestValue(),
		      ((BLOCK_SECTION *) Section->JumpSection)->SectionID);
    }
}
			       ...
			       uint32_t Test)
{
    ...
    if (StartSection->StartPC == Addr) {
	return StartSection;
    }
    if (StartSection->Test == Test) {
	return NULL;
    }
...
void FillSectionInfo(BLOCK_SECTION * Section)
{
	...
	case R4300i_SPECIAL:
		...
		if (IsConst(Command.rt)) {
		    ...
		    MipsRegLo(Command.rd) =
			MipsRegLo(Command.rt) << Command.sa;
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		break;
		...
		if (IsConst(Command.rt)) {
		    MipsRegState(Command.rd) = STATE_CONST_32;
		    MipsRegLo(Command.rd) =
			MipsRegLo_S(Command.rt) >> Command.sa;
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		break;
		...
		if (Section->InLoop
		    && (Command.rt == Command.rd
			|| Command.rs == Command.rd)) {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
		    ...
		    MipsReg(Command.rd) =
			Is64Bit(Command.rt) ? MipsReg(Command.
						      rt) : (QWORD)
			MipsRegLo_S(Command.
				    rt) << (MipsRegLo(Command.rs) & 0x3F);
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		break;
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
		    MipsRegState(Command.rd) = STATE_CONST_64;
		    MipsReg(Command.rd) =
			Is64Bit(Command.rt) ? MipsReg_S(Command.
							rt) : (int64_t)
			MipsRegLo_S(Command.
				    rt) >> (MipsRegLo(Command.rs) & 0x3F);
		} else {
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
		    MipsRegLo(Command.rd) =
			MipsRegLo(Command.rs) + MipsRegLo(Command.rt);
		    MipsRegState(Command.rd) = STATE_CONST_32;
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
			...
			MipsReg(Command.rd) =
			    MipsReg(Command.rt) & MipsReg(Command.rs);
			MipsRegState(Command.rd) = STATE_CONST_64;
		    } else if (Is64Bit(Command.rt) || Is64Bit(Command.rs)) {
			if (Is64Bit(Command.rt)) {
			    MipsReg(Command.rd) =
				MipsReg(Command.rt) & MipsRegLo(Command.
								rs);
			} else {
			    MipsReg(Command.rd) =
				MipsRegLo(Command.rt) & MipsReg(Command.
								rs);
			}
			MipsRegState(Command.rd) =
			    ConstantsType(MipsReg(Command.rd));
		    } else {
			MipsRegLo(Command.rd) =
			    MipsRegLo(Command.rt) & MipsRegLo(Command.rs);
			MipsRegState(Command.rd) = STATE_CONST_32;
		    }
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
			...
			if (Is64Bit(Command.rt)) {
			    MipsReg(Command.rd) =
				~(MipsReg(Command.rt) |
				  MipsRegLo(Command.rs));
			} else {
			    MipsReg(Command.rd) =
				~(MipsRegLo(Command.rt) |
				  MipsReg(Command.rs));
			}
			MipsRegState(Command.rd) = STATE_CONST_64;
		    } else {
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
			...
			if (Is64Bit(Command.rt)) {
			    MipsRegLo(Command.rd) =
				(MipsRegLo_S(Command.rs) <
				 MipsReg_S(Command.rt)) ? 1 : 0;
			} else {
			    MipsRegLo(Command.rd) =
				(MipsReg_S(Command.rs) <
				 MipsRegLo_S(Command.rt)) ? 1 : 0;
			}
		    } else {
			MipsRegLo(Command.rd) =
			    (MipsRegLo_S(Command.rs) <
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
			...
			if (Is64Bit(Command.rt)) {
			    MipsRegLo(Command.rd) =
				(MipsRegLo(Command.rs) <
				 MipsReg(Command.rt)) ? 1 : 0;
			} else {
			    MipsRegLo(Command.rd) =
				(MipsReg(Command.rs) <
				 MipsRegLo(Command.rt)) ? 1 : 0;
			}
		    } else {
			MipsRegLo(Command.rd) =
			    (MipsRegLo(Command.rs) <
		...
		if (IsConst(Command.rt) && IsConst(Command.rs)) {
		    MipsReg(Command.rd) =
			Is64Bit(Command.rs) ? MipsReg(Command.
						      rs) : (int64_t)
			MipsRegLo_S(Command.rs) +
			Is64Bit(Command.rt) ? MipsReg(Command.
						      rt) : (int64_t)
			MipsRegLo_S(Command.rt);
		    MipsRegState(Command.rd) = STATE_CONST_64;
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		...
		if (IsConst(Command.rt)) {
		    MipsRegState(Command.rd) = STATE_CONST_64;
		    MipsReg(Command.rd) =
			MipsRegLo(Command.rt) << (Command.sa + 32);
		} else {
		    MipsRegState(Command.rd) = STATE_UNKNOWN;
		}
		break;
	...
	case R4300i_REGIMM:
		...
		Section->Jump.TargetPC =
		    Section->CompilePC + ((short) Command.offset << 2) + 4;
		if (Section->CompilePC == Section->Jump.TargetPC) {
		    if (!DelaySlotEffectsCompare
			(Section->CompilePC, Command.rs, 0)) {
	...
	case R4300i_JAL:
	    ...
	    MipsRegState(31) = STATE_CONST_32;
	    Section->Jump.TargetPC =
		(Section->CompilePC & 0xF0000000) + (Command.target << 2);
	    if (Section->CompilePC == Section->Jump.TargetPC) {
	...
	case R4300i_BGTZ:
	    ...
	    if (Section->CompilePC == Section->Jump.TargetPC) {
		if (!DelaySlotEffectsCompare
		    (Section->CompilePC, Command.rs, Command.rt)) {
		    Section->Jump.PermLoop = 1;
		}
	    }
	    break;
	...
	case R4300i_ADDIU:
	    ...
	    if (IsConst(Command.rs)) {
		MipsRegLo(Command.rt) =
		    MipsRegLo(Command.rs) + (short) Command.immediate;
	...
	case R4300i_SLTI:
		...
		if (Is64Bit(Command.rs)) {
		    MipsRegLo(Command.rt) =
			(MipsReg_S(Command.rs) <
			 (int64_t) ((short) Command.immediate)) ? 1 : 0;
		} else {
		    MipsRegLo(Command.rt) =
			(MipsRegLo_S(Command.rs) <
			 (int) ((short) Command.immediate)) ? 1 : 0;
		}
		MipsRegState(Command.rt) = STATE_CONST_32;
	    } else {
		MipsRegState(Command.rt) = STATE_UNKNOWN;
	...
	case R4300i_SLTIU:
		...
		if (Is64Bit(Command.rs)) {
		    MipsRegLo(Command.rt) =
			 ((int64_t) MipsReg(Command.rs) <
                          (int64_t) ((short) Command.immediate)) ? 1 : 0;
		} else {
		    MipsRegLo(Command.rt) =
			(MipsRegLo(Command.rs) <
			 (uint32_t) ((short) Command.immediate)) ? 1 : 0;
		}
		MipsRegState(Command.rt) = STATE_CONST_32;
	    } else {
		MipsRegState(Command.rt) = STATE_UNKNOWN;
	...
	case R4300i_ANDI:
		...
		MipsRegState(Command.rt) = STATE_CONST_32;
		MipsRegLo(Command.rt) =
		    MipsRegLo(Command.rs) & Command.immediate;
	    } else {
		MipsRegState(Command.rt) = STATE_UNKNOWN;
	    }
	    break;
	...
	case R4300i_CP1:
		...
		case R4300i_COP1_BC_BCTL:
		    ...
		    Section->Jump.TargetPC =
			Section->CompilePC +
			((short) Command.offset << 2) + 4;
		    if (Section->CompilePC == Section->Jump.TargetPC) {
			int EffectDelaySlot;
			OPCODE NewCommand;

			if (!r4300i_LW_VAddr
			    (Section->CompilePC + 4, &NewCommand.Hex)) {
			    //DisplayError(GS(MSG_FAIL_LOAD_WORD));
			    //ExitThread(0);
			    StopEmulation();
			}
			...
			if (NewCommand.op == R4300i_CP1) {
			    if (NewCommand.fmt == R4300i_COP1_S
				&& (NewCommand.funct & 0x30) == 0x30) {
				EffectDelaySlot = 1;
			    }
			    if (NewCommand.fmt == R4300i_COP1_D
				&& (NewCommand.funct & 0x30) == 0x30) {
				EffectDelaySlot = 1;
			    }
			}
	...
	case R4300i_DADDIU:
		...
		if (Is64Bit(Command.rs)) {
		    ...
		    int64_t imm64 = imm32;
		    MipsReg_S(Command.rt) =
			MipsRegLo_S(Command.rs) + imm64;
		} else {
		    MipsReg_S(Command.rt) =
			MipsRegLo_S(Command.rs) +
			(short) Command.immediate;
		}
	...
	default:
	    ...
	    if (Command.Hex == 0x7FFFFFFF) {
		break;
	    }
	    if (Command.Hex == 0xF1F3F5F7) {
		break;
	    }
	    if (Command.Hex == 0xC1200000) {
		break;
	    }
	    if (Command.Hex == 0x4C5A5353) {
		break;
	    }
	}
	...
	case LIKELY_DELAY_SLOT:
	    memcpy(&Section->Cont.RegSet, &Section->RegWorking,
		   sizeof(REG_INFO));
	...
	case DELAY_SLOT_DONE:
	    memcpy(&Section->Cont.RegSet, &Section->RegWorking,
		   sizeof(REG_INFO));
	    memcpy(&Section->Jump.RegSet, &Section->RegWorking,
		   sizeof(REG_INFO));
	    NextInstruction = END_BLOCK;
	    break;
	...
	if ((Section->CompilePC & 0xFFFFF000) !=
	    (Section->StartPC & 0xFFFFF000)) {
	...
	if ((Section->Cont.TargetPC & 0xFFFFF000) !=
	    (Section->StartPC & 0xFFFFF000)) {
	    Section->Cont.TargetPC = (uint32_t) - 1;
	}
    }
    if (Section->Jump.TargetPC != (uint32_t) - 1) {
	if ((Section->Jump.TargetPC & 0xFFFFF000) !=
	    (Section->StartPC & 0xFFFFF000)) {
	    Section->Jump.TargetPC = (uint32_t) - 1;
	}
    }
...
void FixConstants(BLOCK_SECTION * Section, uint32_t Test, int *Changed)
{
	...
	for (NoOfParents = 0; Section->ParentSection[NoOfParents] != NULL;
		...
		for (count = 0; count < 32; count++) {
		    if (Section->RegStart.MIPS_RegState[count] !=
			Parent->Cont.RegSet.MIPS_RegState[count]) {
			Section->RegStart.MIPS_RegState[count] =
			    STATE_UNKNOWN;
			//*Changed = 1;
		    }
		    Section->RegStart.MIPS_RegState[count] = STATE_UNKNOWN;
	    ...
	    memcpy(&Section->RegWorking, &Section->RegStart,
		   sizeof(REG_INFO));
	}
    }
    FillSectionInfo(Section);
    if (memcmp(&Original[0], &Section->Cont.RegSet, sizeof(REG_INFO)) != 0) {
	*Changed = 1;
    }
    if (memcmp(&Original[1], &Section->Jump.RegSet, sizeof(REG_INFO)) != 0) {
	*Changed = 1;
    }

    if (Section->JumpSection) {
	FixConstants((BLOCK_SECTION*)Section->JumpSection, Test, Changed);
    }
    if (Section->ContinueSection) {
	FixConstants((BLOCK_SECTION*)Section->ContinueSection, Test, Changed);
    }
}
...
void FreeSection(BLOCK_SECTION * Section, BLOCK_SECTION * Parent)
{
	...
	for (count = 0; count < NoOfParents; count++) {
		...
		if (NoOfParents == 1) {
		    ...
		    memmove(&Section->ParentSection[count],
			    &Section->ParentSection[count + 1],
			    sizeof(void *) * (NoOfParents - count));
		    Section->ParentSection = (void**)
			realloc(Section->ParentSection,
				NoOfParents * sizeof(void *));
		}
		NoOfParents -= 1;
	    }
	}
	...
	if (Section->ParentSection) {
	    for (count = 0; count < NoOfParents; count++) {
		if (!IsAllParentLoops
		    (Section, (BLOCK_SECTION*)Section->ParentSection[count], 0,
		     GetNewTestValue())) {
		    return;
		}
	    }
...
void GenerateSectionLinkage(BLOCK_SECTION * Section)
{
	...
	for (count = 0; count < 2; count++) {
	    ...
	    MoveConstToVariable(JumpInfo[count]->TargetPC,
				&JumpToLocation);
	    if (JumpInfo[(count + 1) & 1]->LinkLocation == NULL) {
		break;
	    }
	    JmpLabel8(0);
	    Jump = RecompPos - 1;
	...
	for (count = 0; count < 2; count++) {
	    ...
	    } else if (TargetSection[count] == NULL
		       && JumpInfo[count]->FallThrough) {
		if (JumpInfo[count]->LinkLocation != NULL) {
		    SetJump32(JumpInfo[count]->LinkLocation, RecompPos);
		    JumpInfo[count]->LinkLocation = NULL;
		    if (JumpInfo[count]->LinkLocation2 != NULL) {
			SetJump32(JumpInfo[count]->LinkLocation2,
				  RecompPos);
			JumpInfo[count]->LinkLocation2 = NULL;
		    }
		}
		if (JumpInfo[count]->TargetPC > (Section->CompilePC + 4)) {
		    CompileExit(JumpInfo[count]->TargetPC,
				&JumpInfo[count]->RegSet, Normal, 1, NULL);
		} else {
		    CompileExit(JumpInfo[count]->TargetPC,
				&JumpInfo[count]->RegSet, Normal, 1, NULL);
		}
		...
		if (JumpInfo[count]->TargetPC ==
		    TargetSection[count]->StartPC) {
		    continue;
		}
		if (JumpInfo[count]->LinkLocation != NULL) {
		    SetJump32(JumpInfo[count]->LinkLocation, RecompPos);
	...
	if (TargetSection[count]->CompiledLocation != NULL) {
		...
		SubConstFromVariable(JumpInfo[count]->RegSet.
				     RandomModifier, &CP0[1]);
		JumpInfo[count]->RegSet.RandomModifier = 0;
	    }
	    if (JumpInfo[count]->RegSet.CycleCount != 0) {
		AddConstToVariable(JumpInfo[count]->RegSet.CycleCount,
				   &CP0[9]);
	    }
		...
		if (JumpInfo[count]->PermLoop) {
		    ...
		    CompileSystemCheck(CycleCount,
				       JumpInfo[count]->TargetPC,
				       JumpInfo[count]->RegSet);
		}
	    } else {
		if (JumpInfo[count]->RegSet.CycleCount != 0) {
		    SubConstFromVariable(JumpInfo[count]->RegSet.
					 CycleCount, &Timers->Timer);
		    JumpInfo[count]->RegSet.CycleCount = 0;
		}
	    }
	    memcpy(&Section->RegWorking, &JumpInfo[count]->RegSet,
		   sizeof(REG_INFO));
	    SyncRegState(Section, &TargetSection[count]->RegStart);
	    JmpLabel32(0);
	    SetJump32((uint32_t *) RecompPos - 1,
		      TargetSection[count]->CompiledLocation);
	}
    }
	...
	if (TargetSection[count]->ParentSection == NULL) {
	    continue;
	}

	for (count2 = 0;
	     TargetSection[count]->ParentSection[count2] != NULL;
	     count2++) {
	...
	if (JumpInfo[count]->FallThrough) {
		...
		CompileSystemCheck(CycleCount, JumpInfo[count]->TargetPC,
				   JumpInfo[count]->RegSet);
	    }
	}
    }
...
uint32_t GenerateX86Code(BLOCK_SECTION * Section, uint32_t Test)
{
	...
	Section->Test = Test;
	if (GenerateX86Code((BLOCK_SECTION*)Section->ContinueSection, Test)) {
	    return 1;
	}
	if (GenerateX86Code((BLOCK_SECTION*)Section->JumpSection, Test)) {
	    return 1;
	}
	return 0;
    }
	...
	for (count = 0; Section->ParentSection[count] != NULL; count++) {
	    ...
	    if (IsAllParentLoops(Section, Parent, 1, GetNewTestValue())) {
		continue;
	    }
	    return 0;
	}
    }
    if (!InheritParentInfo(Section)) {
	return 0;
    }
	...
	case R4300i_SPECIAL:
		...
		break;
	    case R4300i_SPECIAL_JR:
		Compile_R4300i_SPECIAL_JR(Section);
		break;
	    case R4300i_SPECIAL_JALR:
		Compile_R4300i_SPECIAL_JALR(Section);
		break;
	    case R4300i_SPECIAL_MFLO:
		Compile_R4300i_SPECIAL_MFLO(Section);
		break;
	    case R4300i_SPECIAL_SYSCALL:
		Compile_R4300i_SPECIAL_SYSCALL(Section);
		break;
	    case R4300i_SPECIAL_BREAK:
		Compile_R4300i_SPECIAL_BREAK(Section);
		break;
		...
		break;
	    case R4300i_SPECIAL_DSLLV:
		Compile_R4300i_SPECIAL_DSLLV(Section);
		break;
	    case R4300i_SPECIAL_DSRLV:
		Compile_R4300i_SPECIAL_DSRLV(Section);
		break;
	    case R4300i_SPECIAL_DSRAV:
		Compile_R4300i_SPECIAL_DSRAV(Section);
		break;
	    case R4300i_SPECIAL_MULT:
		Compile_R4300i_SPECIAL_MULT(Section);
		break;
		...
		break;
	    case R4300i_SPECIAL_DMULT:
		Compile_R4300i_SPECIAL_DMULT(Section);
		break;
	    case R4300i_SPECIAL_DMULTU:
		Compile_R4300i_SPECIAL_DMULTU(Section);
		break;
	    case R4300i_SPECIAL_DDIV:
		Compile_R4300i_SPECIAL_DDIV(Section);
		break;
	    case R4300i_SPECIAL_DDIVU:
		Compile_R4300i_SPECIAL_DDIVU(Section);
		break;
		...
		break;
	    case R4300i_SPECIAL_NOR:
		Compile_R4300i_SPECIAL_NOR(Section);
		break;
	    case R4300i_SPECIAL_SLT:
		Compile_R4300i_SPECIAL_SLT(Section);
		break;
		...
		break;
	    case R4300i_SPECIAL_DSUB:
		Compile_R4300i_SPECIAL_DSUB(Section);
		break;
	    case R4300i_SPECIAL_DSUBU:
		Compile_R4300i_SPECIAL_DSUBU(Section);
		break;
	    case R4300i_SPECIAL_DSLL:
		Compile_R4300i_SPECIAL_DSLL(Section);
		break;
	    case R4300i_SPECIAL_DSRL:
		Compile_R4300i_SPECIAL_DSRL(Section);
		break;
	    case R4300i_SPECIAL_DSRA:
		Compile_R4300i_SPECIAL_DSRA(Section);
		break;
	    case R4300i_SPECIAL_DSLL32:
		Compile_R4300i_SPECIAL_DSLL32(Section);
		break;
	    case R4300i_SPECIAL_DSRL32:
		Compile_R4300i_SPECIAL_DSRL32(Section);
		break;
	    case R4300i_SPECIAL_DSRA32:
		Compile_R4300i_SPECIAL_DSRA32(Section);
		break;
	...
	case R4300i_REGIMM:
	    switch (Opcode.rt) {
	    case R4300i_REGIMM_BLTZ:
		Compile_R4300i_Branch(Section, BLTZ_Compare, BranchTypeRs,
				      0);
		break;
	    case R4300i_REGIMM_BGEZ:
		Compile_R4300i_Branch(Section, BGEZ_Compare, BranchTypeRs,
				      0);
		break;
	    case R4300i_REGIMM_BLTZL:
		Compile_R4300i_BranchLikely(Section, BLTZ_Compare, 0);
		break;
	    case R4300i_REGIMM_BGEZL:
		Compile_R4300i_BranchLikely(Section, BGEZ_Compare, 0);
		break;
	    case R4300i_REGIMM_BLTZAL:
		Compile_R4300i_Branch(Section, BLTZ_Compare, BranchTypeRs,
				      1);
	    ...
	    break;
	case R4300i_BEQ:
	    Compile_R4300i_Branch(Section, BEQ_Compare, BranchTypeRsRt, 0);
	    break;
	case R4300i_BNE:
	    Compile_R4300i_Branch(Section, BNE_Compare, BranchTypeRsRt, 0);
	    break;
	case R4300i_BGTZ:
	    Compile_R4300i_Branch(Section, BGTZ_Compare, BranchTypeRs, 0);
	    break;
	case R4300i_BLEZ:
	    Compile_R4300i_Branch(Section, BLEZ_Compare, BranchTypeRs, 0);
	    break;
	case R4300i_J:
	    Compile_R4300i_J(Section);
	    break;
	case R4300i_JAL:
	    Compile_R4300i_JAL(Section);
	    break;
	case R4300i_ADDI:
	    Compile_R4300i_ADDI(Section);
	    break;
	...
	case R4300i_CP0:
	    switch (Opcode.rs) {
	    case R4300i_COP0_MF:
		Compile_R4300i_COP0_MF(Section);
		break;
	    case R4300i_COP0_MT:
		Compile_R4300i_COP0_MT(Section);
		break;
	    default:
		if ((Opcode.rs & 0x10) != 0) {
		    switch (Opcode.funct) {
		    case R4300i_COP0_CO_TLBR:
			Compile_R4300i_COP0_CO_TLBR(Section);
			break;
		    case R4300i_COP0_CO_TLBWI:
			Compile_R4300i_COP0_CO_TLBWI(Section);
			break;
		    case R4300i_COP0_CO_TLBWR:
			Compile_R4300i_COP0_CO_TLBWR(Section);
			break;
		    case R4300i_COP0_CO_TLBP:
			Compile_R4300i_COP0_CO_TLBP(Section);
			break;
		    case R4300i_COP0_CO_ERET:
	...
	case R4300i_CP1:
		...
		break;
	    case R4300i_COP1_DMF:
		Compile_R4300i_COP1_DMF(Section);
		break;
	    case R4300i_COP1_CF:
		Compile_R4300i_COP1_CF(Section);
		break;
		...
		break;
	    case R4300i_COP1_DMT:
		Compile_R4300i_COP1_DMT(Section);
		break;
	    case R4300i_COP1_CT:
		Compile_R4300i_COP1_CT(Section);
		break;
		...
		switch (Opcode.ft) {
		case R4300i_COP1_BC_BCF:
		    Compile_R4300i_Branch(Section, COP1_BCF_Compare,
					  BranchTypeCop1, 0);
		    break;
		case R4300i_COP1_BC_BCT:
		    Compile_R4300i_Branch(Section, COP1_BCT_Compare,
					  BranchTypeCop1, 0);
		    break;
		case R4300i_COP1_BC_BCFL:
		    Compile_R4300i_BranchLikely(Section, COP1_BCF_Compare,
						0);
		    break;
		case R4300i_COP1_BC_BCTL:
		    Compile_R4300i_BranchLikely(Section, COP1_BCT_Compare,
						0);
		    break;
		default:
		    Compile_R4300i_UnknownOpcode(Section);
		...
		case R4300i_COP1_FUNCT_TRUNC_L:
		    Compile_R4300i_COP1_S_TRUNC_L(Section);
		    break;
		case R4300i_COP1_FUNCT_CEIL_L:
		    Compile_R4300i_COP1_S_CEIL_L(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_FLOOR_L:
		    Compile_R4300i_COP1_S_FLOOR_L(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_ROUND_W:
		    Compile_R4300i_COP1_S_ROUND_W(Section);
		    break;
		...
		case R4300i_COP1_FUNCT_CEIL_W:
		    Compile_R4300i_COP1_S_CEIL_W(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_FLOOR_W:
		    Compile_R4300i_COP1_S_FLOOR_W(Section);
		    break;
		case R4300i_COP1_FUNCT_CVT_D:
		    ...
		    break;
		case R4300i_COP1_FUNCT_CVT_W:
		    Compile_R4300i_COP1_S_CVT_W(Section);
		    break;
		case R4300i_COP1_FUNCT_CVT_L:
		    Compile_R4300i_COP1_S_CVT_L(Section);
		    break;
		case R4300i_COP1_FUNCT_C_F:
		case R4300i_COP1_FUNCT_C_UN:
		case R4300i_COP1_FUNCT_C_EQ:
		...
		case R4300i_COP1_FUNCT_MOV:
		    ...
		    break;
		case R4300i_COP1_FUNCT_TRUNC_L:
		    Compile_R4300i_COP1_D_TRUNC_L(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_CEIL_L:
		    Compile_R4300i_COP1_D_CEIL_L(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_FLOOR_L:
		    Compile_R4300i_COP1_D_FLOOR_L(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_ROUND_W:
		...
		case R4300i_COP1_FUNCT_TRUNC_W:
		    ...
		    break;
		case R4300i_COP1_FUNCT_CEIL_W:
		    Compile_R4300i_COP1_D_CEIL_W(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_FLOOR_W:
		    Compile_R4300i_COP1_D_FLOOR_W(Section);
		    break;	//added by Witten
		case R4300i_COP1_FUNCT_CVT_S:
		    Compile_R4300i_COP1_D_CVT_S(Section);
		    break;
		case R4300i_COP1_FUNCT_CVT_W:
		    ...
		    break;
		case R4300i_COP1_FUNCT_CVT_L:
		    Compile_R4300i_COP1_D_CVT_L(Section);
		    break;
		case R4300i_COP1_FUNCT_C_F:
		case R4300i_COP1_FUNCT_C_UN:
		case R4300i_COP1_FUNCT_C_EQ:
		...
		switch (Opcode.funct) {
		case R4300i_COP1_FUNCT_CVT_S:
		    Compile_R4300i_COP1_L_CVT_S(Section);
		    break;
		case R4300i_COP1_FUNCT_CVT_D:
		    Compile_R4300i_COP1_L_CVT_D(Section);
		    break;
		default:
		    Compile_R4300i_UnknownOpcode(Section);
		    break;
	    ...
	    break;
	case R4300i_BEQL:
	    Compile_R4300i_BranchLikely(Section, BEQ_Compare, 0);
	    break;
	case R4300i_BNEL:
	    Compile_R4300i_BranchLikely(Section, BNE_Compare, 0);
	    break;
	case R4300i_BGTZL:
	    Compile_R4300i_BranchLikely(Section, BGTZ_Compare, 0);
	    break;
	case R4300i_BLEZL:
	    Compile_R4300i_BranchLikely(Section, BLEZ_Compare, 0);
	    break;
	case R4300i_DADDIU:
	    Compile_R4300i_DADDIU(Section);
	    break;
	case R4300i_LDL:
	    Compile_R4300i_LDL(Section);
	    break;
	case R4300i_LDR:
	    Compile_R4300i_LDR(Section);
	    break;
	case R4300i_LB:
	    Compile_R4300i_LB(Section);
	    break;
	...
	case R4300i_LHU:
	    ...
	    break;
	case R4300i_LWR:
	    Compile_R4300i_LWR(Section);
	    break;
	case R4300i_LWU:
	    Compile_R4300i_LWU(Section);
	    break;		//added by Witten
	case R4300i_SB:
	    Compile_R4300i_SB(Section);
	    break;
	...
	case R4300i_SWR:
	    ...
	    break;
	case R4300i_SDL:
	    Compile_R4300i_SDL(Section);
	    break;
	case R4300i_SDR:
	    Compile_R4300i_SDR(Section);
	    break;
	case R4300i_CACHE:
	    Compile_R4300i_CACHE(Section);
	    break;
	case R4300i_LL:
	    Compile_R4300i_LL(Section);
	    break;
	case R4300i_LWC1:
	    Compile_R4300i_LWC1(Section);
	    break;
	...
	if ((Section->CompilePC & 0xFFC) == 0xFFC) {
		...
		CompileExit(Section->CompilePC + 4, &Section->RegWorking,
			    Normal, 1, NULL);
		NextInstruction = END_BLOCK;
	    }
	}
...
void InheritConstants(BLOCK_SECTION * Section)
{
    ...
    RegSet =
	Section ==
	Parent->ContinueSection ? &Parent->Cont.RegSet : &Parent->Jump.
	RegSet;
    memcpy(&Section->RegStart, RegSet, sizeof(REG_INFO));
    memcpy(&Section->RegWorking, &Section->RegStart, sizeof(REG_INFO));

    for (NoOfParents = 1; Section->ParentSection[NoOfParents] != NULL;
	 NoOfParents++) {
	Parent = (BLOCK_SECTION*)Section->ParentSection[NoOfParents];
	RegSet =
	    Section ==
	...
	for (count = 0; count < 32; count++) {
		...
		} else if (Is32Bit(count)
			   && MipsRegLo(count) !=
			   RegSet->MIPS_RegVal[count].UW[0]) {
		    MipsRegState(count) = STATE_UNKNOWN;
		} else if (Is64Bit(count)
			   && MipsReg(count) !=
			   RegSet->MIPS_RegVal[count].UDW) {
		    MipsRegState(count) = STATE_UNKNOWN;
		}
	    }
	}
...
uint32_t InheritParentInfo(BLOCK_SECTION * Section)
{
    int count, start, NoOfParents, NoOfCompiledParents, FirstParent,
	CurrentParent;
    ...
    DisplaySectionInformation(Section, Section->SectionID,
			      GetNewTestValue());
	...
	Parent = (BLOCK_SECTION*)Section->ParentSection[count];
	NoOfParents +=
	    Parent->JumpSection != Parent->ContinueSection ? 1 : 2;
    }
	...
	Parent = (BLOCK_SECTION*)Section->ParentSection[0];
	if (Section == Parent->ContinueSection) {
	    JumpInfo = &Parent->Cont;
	} else if (Section == Parent->JumpSection) {
	    JumpInfo = &Parent->Jump;
	} else {
	}
    ...
    //Multiple Parents
    for (count = 0, NoOfCompiledParents = 0;
	 Section->ParentSection[count] != NULL; count++) {
	Parent = (BLOCK_SECTION*)Section->ParentSection[count];
	if (Parent->CompiledLocation != NULL) {
	    NoOfCompiledParents +=
		Parent->JumpSection != Parent->ContinueSection ? 1 : 2;
    ...
    SectionParents =
	(BLOCK_PARENT *) malloc(NoOfParents * sizeof(BLOCK_PARENT));
	...
	if (Parent->JumpSection != Parent->ContinueSection) {
		...
		Section ==
		Parent->ContinueSection ? &Parent->Cont : &Parent->Jump;
	...
	for (count2 = 1; count2 < 32; count2++) {
		...
		case STATE_CONST_64:
		    ...
		    break;
		case STATE_CONST_32:
		    if ((RegSet->MIPS_RegVal[count2].W[0] < 0)
			&& IsUnsigned(count2)) {
			MipsRegState(count2) = STATE_MAPPED_32_SIGN;
		    }
		    break;
		...
		} else if (Is32Bit(count2)
			   && MipsRegLo(count2) !=
			   RegSet->MIPS_RegVal[count2].UW[0]) {
		    Map_GPR_32bit(Section, count2, 1, count2);
		} else if (Is64Bit(count2)
			   && MipsReg(count2) !=
			   RegSet->MIPS_RegVal[count2].UDW) {
		    Map_GPR_32bit(Section, count2, 1, count2);
		}
	    }
	    for (count3 = 1; count3 < 64; count3++) {
		x86Protected(count3) = 0;
	    }
	}
    }
    memcpy(&Section->RegStart, &Section->RegWorking, sizeof(REG_INFO));
...
//      sprintf(Label,"Section_%d",Section->SectionID);
	...
	if (JumpInfo->RegSet.CycleCount != 0) {
	    NeedSync = 1;
	}
	if (JumpInfo->RegSet.RandomModifier != 0) {
	    NeedSync = 1;
	}
			  ...
			  uint32_t IgnoreIfCompiled, uint32_t Test)
{
	...
	if (!IsAllParentLoops
	    (Section, (BLOCK_SECTION*)Parent->ParentSection[count], IgnoreIfCompiled,
	     Test)) {
	    return 0;
	}
    }
...
void SyncRegState(BLOCK_SECTION * Section, REG_INFO * SyncTo)
{
    ...
    UnMap_AllFPRs(Section);
    if (CurrentRoundingModel != SyncTo->RoundingModel) {
	CurrentRoundingModel = RoundUnknown;
    }
