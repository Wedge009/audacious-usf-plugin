...
void RSP_LFV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	*(DMEM + ((((Addr + ((0x4 - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[5] =
	*(DMEM + ((((Addr + ((0x8 - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[4] =
	*(DMEM + ((((Addr + ((0xC - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[3] =
	*(DMEM + ((((Addr + ((0x8 - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[2] =
	*(DMEM + ((((Addr + ((0xC - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[1] =
	*(DMEM + ((((Addr + ((0x10 - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
    Temp.HW[0] =
	*(DMEM + ((((Addr + ((0x4 - element) ^ 3)) & 0xf)) & 0xFFF)) << 7;
...
{
    RSP_Vect[vect].HW[7] =
	*(DMEM + (((Addr + ((0x10 - element) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[6] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 2) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[5] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 4) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[4] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 6) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[3] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 8) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[2] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 10) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[1] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 12) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[0] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 14) & 0xF)) ^ 3) & 0xFFF)) << 7;
}
...
{
    RSP_Vect[vect].HW[7] =
	*(DMEM + (((Addr + ((0x10 - element) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[6] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 1) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[5] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 2) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[4] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 3) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[3] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 4) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[2] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 5) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[1] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 6) & 0xF)) ^ 3) & 0xFFF)) << 8;
    RSP_Vect[vect].HW[0] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 7) & 0xF)) ^ 3) & 0xFFF)) << 8;
}
...
void RSP_LUV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	*(DMEM + (((Addr + ((0x10 - element) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[6] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 1) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[5] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 2) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[4] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 3) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[3] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 4) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[2] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 5) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[1] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 6) & 0xF)) ^ 3) & 0xFFF)) << 7;
    RSP_Vect[vect].HW[0] =
	*(DMEM +
	  (((Addr + ((0x10 - element + 7) & 0xF)) ^ 3) & 0xFFF)) << 7;
}
...
void RSP_SFV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	*(DMEM + ((Addr + ((offset + 4) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[6] >> 7;
	*(DMEM + ((Addr + ((offset + 8) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[5] >> 7;
	*(DMEM + ((Addr + ((offset + 12) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[4] >> 7;
	break;
    case 1:
	*(DMEM + ((Addr + offset) ^ 3)) = RSP_Vect[vect].UHW[1] >> 7;
	*(DMEM + ((Addr + ((offset + 4) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[0] >> 7;
	*(DMEM + ((Addr + ((offset + 8) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[3] >> 7;
	*(DMEM + ((Addr + ((offset + 12) & 0xF)) ^ 3)) =
	    RSP_Vect[vect].UHW[2] >> 7;
	break;
    case 2:
...
{
    *(DMEM + ((Addr ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(15 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(14 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 2) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(13 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(12 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 4) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(11 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(10 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 6) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(9 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(8 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 8) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(7 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(6 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 10) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(5 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(4 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 12) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(3 - element) & 0xF] << 1) +
	(RSP_Vect[vect].UB[(2 - element) & 0xF] >> 7);
    *(DMEM + (((Addr + 14) ^ 3) & 0xFFF)) =
	(RSP_Vect[vect].UB[(1 - element) & 0xF] << 1) +
...
void RSP_SPV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	if (((Count) & 0xF) < 8) {
	    *(DMEM + ((Addr ^ 3) & 0xFFF)) =
		RSP_Vect[vect].UB[15 - ((Count & 0xF) << 1)];
	} else {
	    *(DMEM + ((Addr ^ 3) & 0xFFF)) =
		(RSP_Vect[vect].UB[15 - ((Count & 0x7) << 1)] << 1) +
...
void RSP_SRV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
    ...
    for (Count = element; Count < (length + element); Count++) {
	*(DMEM + ((Addr ^ 3) & 0xFFF)) =
	    RSP_Vect[vect].B[15 - ((Count + offset) & 0xF)];
	Addr += 1;
    }
}
...
void RSP_STV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	*(DMEM + ((Addr ^ 3) & 0xFFF)) =
	    RSP_Vect[vect + del].UB[15 - count];
	*(DMEM + (((Addr + 1) ^ 3) & 0xFFF)) =
	    RSP_Vect[vect + del].UB[14 - count];
	del = (del + 1) & 7;
	Addr += 2;
    }
}
...
void RSP_SUV_DMEM(uint32_t Addr, int32_t vect, int32_t element)
{
	...
	if (((Count) & 0xF) < 8) {
	    ...
	    *(DMEM + ((Addr ^ 3) & 0xFFF)) =
		RSP_Vect[vect].UB[15 - ((Count & 0x7) << 1)];
	}
	Addr += 1;
    }
}
...
int32_t init_rsp(void)
{
    ...
    asm volatile ("push %%ebx; mov $1, %%eax; cpuid; pop %%ebx"::"a"
		  (CpuFeatures):"edx", "ecx");
#else
    asm volatile ("push %%rbx; mov $1, %%eax; cpuid; pop %%rbx"::"a"
		  (CpuFeatures):"rdx", "rcx");
#endif
...
void RSPSetJumpTable(void)
{
    ...
    RSPJumpTable =
	(void **) (RSPJumpTables + (NoOfMaps * (sizeof(void *) * 0x400)));
    Table = NoOfMaps;
    NoOfMaps += 1;
}
